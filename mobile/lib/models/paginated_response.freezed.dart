...
mixin _$PaginatedResponse<T> {
 ...
 List<T> get items; int get total; int get page;@JsonKey(name: 'page_size') int get pageSize; int get pages;
...
int get hashCode {
  final _this = this as PaginatedResponse<T>;
  return Object.hash(runtimeType,const DeepCollectionEquality().hash(_this.items),_this.total,_this.page,_this.pageSize,_this.pages);
}

@override
String toString() {
  final _this = this as PaginatedResponse<T>;
  return 'PaginatedResponse<$T>(items: ${_this.items}, total: ${_this.total}, page: ${_this.page}, pageSize: ${_this.pageSize}, pages: ${_this.pages})';
}
...
@useResult
$Res call({
 List<T> items, int total, int page,@JsonKey(name: 'page_size') int pageSize, int pages
});
...
/// Create a copy of PaginatedResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? items = null,Object? total = null,Object? page = null,Object? pageSize = null,Object? pages = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<T> items,  int total,  int page, @JsonKey(name: 'page_size')  int pageSize,  int pages)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaginatedResponse() when $default != null:
return $default(_that.items,_that.total,_that.page,_that.pageSize,_that.pages);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<T> items,  int total,  int page, @JsonKey(name: 'page_size')  int pageSize,  int pages)  $default,) {final _that = this;
switch (_that) {
case _PaginatedResponse():
return $default(_that.items,_that.total,_that.page,_that.pageSize,_that.pages);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<T> items,  int total,  int page, @JsonKey(name: 'page_size')  int pageSize,  int pages)?  $default,) {final _that = this;
switch (_that) {
case _PaginatedResponse() when $default != null:
return $default(_that.items,_that.total,_that.page,_that.pageSize,_that.pages);case _:
  return null;
...
class _PaginatedResponse<T> implements PaginatedResponse<T> {
  const _PaginatedResponse({required  List<T> items, required this.total, required this.page, @JsonKey(name: 'page_size') required this.pageSize, required this.pages}): _items = items;
...
@override
int get hashCode {
    return Object.hash(runtimeType,const DeepCollectionEquality().hash(_items),total,page,pageSize,pages);
}

@override
String toString() {
    return 'PaginatedResponse<$T>(items: $items, total: $total, page: $page, pageSize: $pageSize, pages: $pages)';
}
...
/// Create a copy of PaginatedResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? items = null,Object? total = null,Object? page = null,Object? pageSize = null,Object? pages = null,}) {
